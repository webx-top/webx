...
func TestRadioButtonRender(t *testing.T) {
	field := fields.RadioField("radio", []fields.InputChoice{
		fields.InputChoice{Id: "choice1", Val: "value1", Checked: false},
		fields.InputChoice{Id: "choice2", Val: "value2", Checked: false},
	})
	field.SetStyle(style)
...
func TestSelectRender(t *testing.T) {
	field := fields.SelectField("select", map[string][]fields.InputChoice{
		"": []fields.InputChoice{
			fields.InputChoice{"choice1", "value1", false},
			fields.InputChoice{"choice2", "value2", false},
		},
...
func TestFormFromSimpleModel(t *testing.T) {
	...
	form := NewFormFromModel(u, "", POST, "/action.html")
	t.Log("Rendered form:", form.Render())
}
...
func TestFormFromModel(t *testing.T) {
	...
	form := NewFormFromModel(Model{"asd", "lol", 20, time.Now(), "B", false}, "", POST, "")
	t.Log("Rendered form:", form.Render())
}
...
func TestPizzaCreation(t *testing.T) {
	...
	form := NewFormFromModel(Pizza{Price: 2.2}, "", POST, "")
	t.Log("Rendered form:", form.Render())
}
